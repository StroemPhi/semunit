 ...
 * [semunit.yml](semunit.yml)
     * Determines how your purl.obolibrary.org/obo/semunit/ redirects will be handled
     ...
     * Paste in the contents of [semunit.yml](semunit.yml)
 ...
 * [semunit.md](semunit.md)
     ...
     * Paste in the contents of [semunit.md](semunit.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
